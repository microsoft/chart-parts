...
import { Mark, GroupItem } from '../../../scenegraph'
import { RendererBase, ChartOptions } from '../..'
...
export class SvgRenderer extends RendererBase<Element, void> {
	...
	constructor(
		...
		sceneGraph: BehaviorSubject<Mark>,
	...
	public renderScene(scene: Mark, options: ChartOptions): Promise<void> {
